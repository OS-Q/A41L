...
all: $(BUILD)/$(OUT_NAME).out $(BUILD)/$(OUT_NAME)_nosd.hex $(BUILD)/$(OUT_NAME)_nosd.uf2 $(BUILD)/$(MERGED_FILE).hex $(BUILD)/$(MERGED_FILE).zip
...
$(BUILD)/$(OUT_NAME)_nosd.uf2: $(BUILD)/$(OUT_NAME)_nosd.hex
	@echo Create $(notdir $@)
...
copy: $(BIN)
	@$(CP) $(BUILD)/$(OUT_NAME)_nosd.uf2 $(BIN)
